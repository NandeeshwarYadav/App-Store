...
class AppStore extends Component {
  ...
  getFilterdAppList = SearchResults => {
    const {activeId} = this.state
    const filterdAppList = SearchResults.filter(
  ...
  getSearchResults = () => {
    ...
    const search = appsList.filter(each =>
  ...
  render() {
    ...
    const filterdAppList = this.getFilterdAppList(SearchResults)
    console.log(filterdAppList)
